...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "00sanpy/gui/main_menu.png"
define gui.game_menu_background = "00sanpy/gui/game_menu.png"
...
## 按钮 ##########################################################################
##
## 这些变量以及 s a n p y /gui/button 中的图像文件控制着按钮显示方式。
...
## s a n p y /gui/button 中的图像文件，就像其他类型的按钮一样。
